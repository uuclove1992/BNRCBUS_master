...
public class NearActivity extends BaseActivity {
	...
	OnItemClickListener popmenuItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if (position == 0) {
				...
				intent.putExtra("TEXT", NearActivity.this.getResources()
				...
				UserDataDBHelper.getInstance(NearActivity.this)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.new_near_view);

		isOpenAlert = "开启提醒功能";
		MobclickAgent.updateOnlineConfig(this);
		String value = MobclickAgent.getConfigParams(NearActivity.this,
				"bus_data_version");
				...
				builder.setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
								DataBaseHelper.getInstance(NearActivity.this)
										.DownFileWithUrl(
		...
		value = MobclickAgent.getConfigParams(NearActivity.this,
		...
		mApplication = LocationUtil.getInstance(NearActivity.this);
		mApplication.startLocation();
		initbase();
		popMenu = new PopMenu(NearActivity.this);
		...
		openAlertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (isOpenAlert.equalsIgnoreCase("开启提醒功能")) {
					isOpenAlert = "关闭提醒功能";
					PollingUtils.startPollingService(NearActivity.this, 5,
					...
					isOpenAlert = "开启提醒功能";
					PollingUtils.stopPollingService(NearActivity.this,
							PollingService.class, PollingService.ACTION);
					openAlertView.setBackgroundResource(R.drawable.alertoffimg);
					Toast toast = Toast.makeText(getApplicationContext(),
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position < allStations.size()) {
					...
					if (segmented.getCheckedRadioButtonId() == R.id.in_month
						...
						intent.putExtra(
								"TEXT",
								NearActivity.this.getResources().getString(
		...
		allRtBuses = UserDataDBHelper.getInstance(NearActivity.this)
				.getMyAllFavRTBus();
			...
			public void run() {
				runOnUiThread(new Runnable() {
					public void run() {
						...
						if (isNetworkConnected(NearActivity.this)) {
							GetAllBuses();
						} else {
	...
	public void getNearbyStationsAndBuslines() {
		favStations = UserDataDBHelper.getInstance(NearActivity.this).favStations;
		favBuslines = UserDataDBHelper.getInstance(NearActivity.this).favBuslines;
		alertStations = UserDataDBHelper.getInstance(NearActivity.this).alertStations;
		allStations.clear();
		ArrayList<String> curItem;

		// 附近
		LocationUtil mApplication = LocationUtil.getInstance(NearActivity.this);
		;
		BDLocation location = mApplication.mLocation;
		nearbyStations = DataBaseHelper.getInstance(NearActivity.this)
		...
		userdabase = UserDataDBHelper.getInstance(NearActivity.this);
		allBuslines.clear();

		nearbyBuslines = DataBaseHelper.getInstance(NearActivity.this)
	...
	public void refreshRealtimeBuses() {
		...
		for (int i = 0; (i < j) && (i < 5); i++) {
			...
			View stationItem = View.inflate(NearActivity.this,
	...
	public void getFavStationsAndBuslines() {
		...
		ArrayList<ArrayList<String>> stations = UserDataDBHelper.getInstance(
				NearActivity.this).getLatestSearchStations();
	...
	public void get_realtime_data(final ArrayList<String> busline,
		...
		if (buslineArrayList.size() > 0) {
			...
			MyVolley.sharedVolley(NearActivity.this).getRequestQueue()
	...
	protected class MyGridAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			// TODO Auto-generated method stub
			View view = View.inflate(NearActivity.this, R.layout.bus_grid_item,
					null);
